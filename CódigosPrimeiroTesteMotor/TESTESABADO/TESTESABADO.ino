...
void ler_instrucao()
{
    ...
    Serial.println("Antes encontrar chave");
    //encontrar_chave();
    Serial.println("Depois encontrar chave");
    ler_variaveis();
        
    soma_arduino = instrucao.motores[X].frequencia + instrucao.motores[Y].frequencia + instrucao.motores[Z].frequencia + instrucao.tempo;
